...
const createShopController = async (req, res) => {
  ...
  const newShopTags = shopTags.split(",").map((tag) => tag.trim());
  console.log("newShopTags", newShopTags);

  console.log("=========controller==============");
  console.log("controller checking lengths of all values", req.body);
  ...
  console.log("====check images cover ============");
  console.log(shopCoverPhoto);
  console.log("====check images icon ============");
  console.log(shopIconPhoto);
